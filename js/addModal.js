...
function addModal(parent) {
	...
	if (existModal == null) {
		...
		install += "<thead><tr><th style='width:40px;' id='_chose'><a hidefocus='' style='hide-focus: true'target='_blank'>选择</a></th><th style='width:72px;' id='_type'><a hidefocus='' style='hide-focus: true'target='_blank'>类型</a></th><th id='_name'><a hidefocus='' style='hide-focus: true'target='_blank'>附件名</a></th><th style='width:144px;' id='_subject'><a hidefocus='' style='hide-focus: true'target='_blank'>主题</a></th><th id='_from'><a hidefocus='' style='hide-focus: true'target='_blank'>发件人</a></th><th id='_to'><a hidefocus='' style='hide-focus: true'target='_blank'>收件人</a></th><th style='width:144px;' id='_date'><a hidefocus='' style='hide-focus: true'target='_blank'>日期</a></th><th style='width:72px;' id='_size'><a hidefocus='' style='hide-focus: true'target='_blank'>大小</a></th></tr></thead><tbody></tbody></table>";
